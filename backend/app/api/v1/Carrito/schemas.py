...
class ItemCheckout(BaseModel):
    ...
    tipo_entrega_seleccionado es requerido aquí porque se valida
    contra lo que permite el Producto antes de crear el pedido.
    """
    id_item: int
...
class CheckoutRequest(BaseModel):
    ...
    def validar_direccion_si_hay_envio(self) -> "CheckoutRequest":
        ...
        Se valida a nivel schema para dar un error 422 claro
