...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_imagenes_entity_id'), 'imagenes', ['entity_id'], unique=False)
    op.create_index(op.f('ix_imagenes_entity_type'), 'imagenes', ['entity_type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_imagenes_entity_type'), table_name='imagenes')
    op.drop_index(op.f('ix_imagenes_entity_id'), table_name='imagenes')
