...
const METODOS = [
  ...
  { id: "paypal",   label: "PayPal",                       icon: <IconBrandPaypalFilled /> },
                    ...
                    {m.id === "stripe" && (
                      <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-2 text-text-light">
                          <span className="font-body text-xs flex items-center gap-1"><IconLock size={14} /> Tu pago es 100% seguro</span>
                          <span className="font-body text-xs">·</span>
                          <span className="font-body text-xs flex items-center gap-1"><IconBoltFilled size={14} /> Paga fácil y rápido</span>
                        </div>
